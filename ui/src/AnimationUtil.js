...
export const kenBurnsFilterExpression = (animationSettings, duration, width, height, fps) => {
...
export const parallaxFilterExpression = (animationSettings, duration, width, height, fps) => {
...
export const cinemagraphFilterExpression = (animationSettings, duration, width, height, fps) => {
...
export const dollyzoomFilterExpression = (animationSettings, duration, width, height, fps) => {
